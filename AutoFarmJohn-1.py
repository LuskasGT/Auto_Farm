...
horario = '22:50:10'   # aqui seria o horario que vc irá colocar para o programa executar o script
...
while True:
    if horas >= horario:
        ...
        pyautogui.write (navegador, interval=0.05)    #Escreve o nome do seu navegador
        ...
        pyautogui.drag(1663, 1013, duration=0.5)  #arrastando o janela 
        p +=1
        if p == 1:
            break
    else:
